...
Compiler.prototype = {
  ...
  /** @type {import('../../../types').default.ICompiler['BlockStatement']} */
  ...
  /** @param {import('@handlebars/parser/types').AST.BlockStatement} sexpr */
 ...
 * @param {import('../../handlebars').HandlebarsEnvironment} env
 */
